 ...
 * Compile the SQL fragment for the native $json_path_match read-query operator.
 */
import QueryError from '#src/errors/query-error.js';
import {bind_parameter} from '#src/sql/parameter-binder.js';
import {is_string} from '#src/utils/value.js';

function jsonpath_match_native_operator(jsonb_expression, comparison_value, parameter_state) {
...
export default jsonpath_match_native_operator;
