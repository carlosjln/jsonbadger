 ...
 * Compile the SQL fragment for the native $json_path_exists read-query operator.
 */
import QueryError from '#src/errors/query-error.js';
import {bind_parameter} from '#src/sql/parameter-binder.js';
import {is_string} from '#src/utils/value.js';

function jsonpath_exists_native_operator(jsonb_expression, comparison_value, parameter_state) {
